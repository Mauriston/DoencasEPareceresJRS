...
<tbody>
<tr>
<td style="padding: 0px; text-align: center; background-color: #050f41; width: 100%;"><img width="100%" style="width: 100%; max-width: 960px; height: auto; display: block; border: 0;" alt="Cabeçalho Hospital Naval de Recife - Junta Regular de Saúde" dfsrc="https://i.imgur.com/Btu1CAG.png" src="https://i.imgur.com/Btu1CAG.png" /></td>
</tr>
<tr>
...
<div style="font-size: 18px; font-weight: bold; color: #050f41; margin: 0;"><span style="font-size: 16pt;">JRS/HNRe AI</span></div>
...
<td height="30"></td>
    ...
    // Clean up temporary doc if you don't want to keep it? The prompt didn't say to delete it, so we'll leave it or move it to trash. Usually people just want the PDF and ODT sent via email. Let's keep it (or as specified: "Salvar o parecer gerado em PDF... Enviar o parecer gerado em PDF e Odt"). Since it says "Salvar em PDF", we can trash the Doc file to keep Drive clean.
...
<tbody>
<tr>
<td style="padding: 0px; text-align: center; background-color: #050f41; width: 100%;"><img width="100%" style="width: 100%; max-width: 960px; height: auto; display: block; border: 0px;" alt="Cabe&ccedil;alho Hospital Naval de Recife - Junta Regular de Sa&uacute;de" dfsrc="https://i.imgur.com/Btu1CAG.png" src="https://i.imgur.com/Btu1CAG.png" /></td>
</tr>
<tr>
<td style="background-color: #ffffff; padding: 40px 50px 30px; text-align: left; font-family: 'carlito' , 'calibri' , 'arial' , sans-serif; font-size: 15px; line-height: 1.6; color: #333333; width: 100%;">
<p style="margin: 0px 0px 20px; font-size: 18px; color: #333333;"><strong>{{PERITO}},</strong></p>
<p style="margin: 0px 0px 20px; font-size: 15px; text-align: justify; color: #333333;"><span style="font-size: 12pt;">Seguem em anexo os pedido de parecer gerado em PDF e edit&aacute;vel em .odt.</span></p>
<div style="background-color: #f4f6f9; border-left: 4px solid #050f41; padding: 20px; margin-bottom: 30px; border-radius: 4px;">
<p style="margin: 0px 0px 10px; font-size: 18px; color: #050f41; font-weight: bold; text-transform: uppercase;">SOLICITA&Ccedil;&Atilde;O DE PARECER ESPECIALIZADO PERICIAL</p>
<ul style="margin: 0px; padding-left: 20px; list-style-type: disc; line-height: 1.6;">
...
<li style="margin-bottom: 6px;"><span style="font-size: 12pt;"><span style="color: #050f41;">Finalidade IS:</span> <span style="color: #050f41; font-weight: bold;">{{FINALIDADE}}</span></span></li>
<li style="margin-bottom: 6px;"><span style="font-size: 12pt;"><span style="color: #050f41;">Especialidade:</span> <span style="font-weight: bold; color: #050f41;">{{ESPECIALIDADE}}</span></span></li>
...
<div style="background-color: #fff5f5; border: 1px solid #f8d7da; padding: 20px; margin-bottom: 35px; border-radius: 4px;">
<p style="margin: 0px; font-size: 15px; color: #333333; line-height: 1.6; text-align: justify;"><span style="color: #ff0000;"><strong><span style="color: #993300;">LEMBRETE:</span> <span style="color: #993300;">Uma vez iniciada a entrevista, a JRS tem <span style="color: #ff0000;">20 dias corridos para concluir a IS.</span> Caso o parecer solicitado n&atilde;o seja prontificado, deveremos concluir a IS utilizando os dados dispon&iacute;veis at&eacute; o momento.</span></strong></span></p>
</div>
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #eeeeee; padding-top: 20px;">
<tbody>
<tr>
<td style="font-family: 'carlito' , 'calibri' , 'arial' , sans-serif; color: #333333;">
<p style="font-size: 15px; margin: 0px 0px 15px; color: #333333;">Atenciosamente,</p>
<div style="font-size: 18px; font-weight: bold; color: #050f41; margin: 0px 0px 2px;">Mauriston Renan Martins Silva</div>
<div style="font-size: 14px; line-height: 1.3; color: #666666; font-weight: normal;"><strong>Capit&atilde;o-Tenente (Md)</strong><br />Presidente</div>
...
<tr>
<td style="background-color: #ececec; padding: 15px 20px; border-top: 1px solid #eeeeee; width: 100%;">
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="width: 100%;">
<tbody>
<tr>
<td width="35%" align="center" valign="middle" style="padding-right: 15px; width: 50.4348%;"><img width="140" style="width: 358px; max-width: 100%; height: 102px; display: inline-block; border: 0px;" alt="Logo Marinha do Brasil" dfsrc="https://i.imgur.com/5JKaEFU.png" src="https://i.imgur.com/5JKaEFU.png" /></td>
<td width="1" style="border-left: 1px solid #cccccc; font-size: 1px; line-height: 1px; width: 6.63044%;">&nbsp;</td>
<td width="65%" align="left" valign="middle" style="padding-left: 20px; font-family: 'carlito' , 'calibri' , 'arial' , sans-serif; font-size: 14px; line-height: 1.6; color: #555555; width: 64%;"><strong style="color: #333333;">Hospital Naval de Recife - Junta Regular de Sa&uacute;de</strong><br />(81) 3036 - 9073 <span style="margin: 0px 8px;">/</span> <a href="mailto:hnre.jrs@marinha.mil.br" style="color: #050f41; text-decoration: none;" rel="noopener nofollow noopener noreferrer nofollow noopener noreferrer nofollow noopener noreferrer" target="_blank">hnre.jrs@marinha.mil.br</a><br />📍 Avenida Cruz Cabug&aacute; 1200, Santo Amaro, Recife/PE</td>
</tr>
</tbody>
</table>
</td>
