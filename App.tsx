    ...
    <div className="flex flex-col min-h-screen bg-gray-light">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-[0_-2px_10px_rgba(0,0,0,0.05)] z-50">
        <div className="flex justify-around items-stretch h-16 max-w-4xl mx-auto">
          <div className="relative group flex flex-col items-center justify-center w-full h-full pt-2 pb-3">
            <button
            ...
            {isBeneficiosFabOpen && (
              <div className="absolute bottom-full left-2 mb-4 bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.15)] border border-gray-100 p-2 flex flex-col gap-1 min-w-[170px] animate-fade-in z-50">
                <button 
          ...
          <div className="relative group flex flex-col items-center justify-center w-full h-full pt-2 pb-3">
            ...
            {isExtrasFabOpen && (
              <div className="absolute bottom-full right-2 mb-4 bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.15)] border border-gray-100 p-2 flex flex-col gap-1 min-w-[150px] animate-fade-in z-50">
                <button 
