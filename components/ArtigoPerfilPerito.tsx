    ...
    <div className="flex flex-col h-full bg-[#F3F5F7] animate-fade-in relative">
      ...
      <div className="p-4 space-y-6 max-w-3xl mx-auto w-full flex-1 pb-32">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm space-y-4 font-body text-sm text-gray-700 leading-relaxed text-justify">
          ...
          <p>
            Como este livro destina-se aos colegas médicos, peritos ou não, e, sendo peritos, abrangendo todas as áreas da atuação médico-pericial, procurarei traçar um perfil único e amplo, no qual o leitor possa melhor compreender a personalidade base do perito médico, independente da área em que atue.
          </p>
          <p>
            Tentarei colocar o máximo possível de esclarecimentos das dificuldades no exercício da função, das dúvidas e mal-entendidos que fazem com que esta 'especialidade' seja ainda tão mal compreendida, em qualquer das áreas de atuação médico-pericial. Nossa intenção, ainda, é levar aos colegas médicos que desejam exercer atividades periciais, em particular legais, forenses ou previdenciárias, um apanhado geral das atribulações e das responsabilidades de que estarão imbuídos no exercício desta nobre, todavia, espinhosa atividade.
          </p>
          <p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm space-y-4 font-body text-sm text-gray-700 leading-relaxed text-justify">
          ...
          <p>
            Nos longos anos de escola médica cursamos, em caráter obrigatório, várias matérias, especialidades da Medicina, e sempre encontramos a que melhor se encaixa em nosso temperamento, perfil ou ideal. Por vezes, nos apaixonamos por mais de uma delas e essa diversidade é o que cria o encanto de, numa mesma profissão, termos tão diferentes tipos de atuações, especialidades, caminhos e escolhas.
          </p>
          <p>
            Assim, para as inúmeras especialidades médicas temos um perfil próprio nas peculiaridades que estas exigem, quer a Clínica Geral, a Cirurgia, a Psiquiatria, a Pediatria e tantas outras que, com certeza, reunirão profissionais de perfis totalmente diversos, apesar de médicos.
          </p>
          <p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm space-y-4 font-body text-sm text-gray-700 leading-relaxed text-justify">
          ...
          <p>
            A seguir, abordaremos algumas atitudes a serem observadas quando no exercício de nossas atribuições.
          </p>
          <p>
          ...
          <p>
            Nas perícias legal e criminal os exames para avaliação de sanidade mental em criminosos psicopatas - que nada têm de doença mental, mas a simulam - são de tirar o profissional do equilíbrio. Muitos dos exames de corpo de delito, em vítimas, geram pena e compaixão intensa.
          </p>
          <p>
        ...
        <div className="bg-gray-100 p-6 rounded-2xl border border-gray-200 shadow-inner space-y-2 font-body text-[11px] text-gray-500 leading-relaxed text-left">
          ...
          <p>BRASIL. Ministério da Previdência e Assistência Social. Instituto Nacional do Seguro Social. Manual do médico perito da previdência social. 3ª ed. Brasília: MPAS, 1993.</p>
          <p>CARNEIRO, M. Técnica, segurança, e ética do perito médico. Resumos científicos, p. 14-21, 2007.</p>
          <p>CÓDIGO de ética médica. Artigos 92-98: desempenho ético da perícia médica.</p>
          <p>DAMIÃO, R. T., HENRIQUES, A. Curso de português jurídico. 8a ed. São Paulo: Atlas, 2000.</p>
          ...
          <p>FRANÇA, G., GIMENEZ, M. Medicina legal. Disponível em: &lt;http://www.medicinalegal.com.br&gt;. Acesso em: 27 ago. 2007.</p>
          <p>FUNDAÇÃO UNIMED. Perícia médica. Disponível em: &lt;http://www.fundacaounimed.org.br/curso_alunos/cursos/curso.php?&gt;. Acesso em: 25 ago. 2007.</p>
          <p>GIL, B. Violência: novatos no alvo. In: I CONGRESSO BRASILEIRO DE PERÍCIA MÉDICA PREVIDENCIÁRIA. Revista da Associação dos médicos peritos da previdência social, Ano 1, nº 2, p. 50, ago. 2007.</p>
          <p>HOLANDA, B. A. Minidicionário da língua portuguesa. 3ª ed. Rio de Janeiro: Nova Fronteira, 2002.</p>
          <p>HOUAISS, A. Dicionário Houaiss da língua portuguesa. Rio de Janeiro: Objetiva, 2001.</p>
          <p>JULIANO, R. Livro-manual de perícias. Disponível em: &lt;http://www.manualdepericias.com.br/menu.asp?&gt;. Acesso em: 30 ago. 2007.</p>
          <p>PEDREIRA, A. A competência emocional. 2ª ed. Salvador: Casa da Qualidade, 1998.</p>
          <p>SENASP/SUSP. Genética forense. Disponível em: &lt;http://www.mj.gov.br/senasp/SUSP/pericias/pericia_dna.htm&gt;. Acesso em: 27 ago. 2007.</p>
          ...
          <p>VILELA, J. R. Entrevista sobre perícia médica. Disponível em: &lt;http://www.fundacaounimed.org.br/atualizacao/entrevista/index.php?&gt;. Acesso em: 30 ago. 2007.</p>
          <p>WEIL, P., TOMPAKOW, R. O corpo fala. 50ª ed. Petrópolis: Vozes, 2000.</p>
          <p>WIKIPÉDIA. Medicina Legal. Disponível em: &lt;http://pt.wikipedia.org/wiki/Medicina_legal&gt;. Acesso em: 25 ago. 2007.</p>
        </div>
