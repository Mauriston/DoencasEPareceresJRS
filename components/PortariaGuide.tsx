...
import { Brain, HeartPulse, EyeOff, Radiation, Activity, Bone, Ribbon, Shield, Wind, Stethoscope, FileText, ChevronDown, ChevronUp, ArrowUp, AlertTriangle, Heart } from 'lucide-react';
...
export const PortariaGuide: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F3F5F7] relative">
      ...
      {/* M3 TRUE FLOATING ELEVATED ACTION BUTTON (FAB) FOR SCROLL-TO-TOP */}
      {showScrollTop && (
        <button 
